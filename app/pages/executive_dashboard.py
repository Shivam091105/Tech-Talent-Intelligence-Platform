"""
Module 1: Executive Dashboard — the "one-glance" overview page.
Shows 4 KPI cards + 4 key charts.
"""

import streamlit as st
from app.components.metrics_card import metric_card, section_header, empty_state
...
def render():
    ...
    st.caption("A high-level overview of the tech talent market")
    ...
    try:
        ...
        with col1:
            ...
            metric_card("Total Jobs", total, icon="📋")
        ...
        with col2:
            ...
            metric_card("Average Salary", avg_sal, icon="💰", prefix="$")
        ...
        with col3:
            ...
            metric_card("Top Skill", top_skill, icon="🔥")
        ...
        with col4:
            ...
            metric_card("Top Hiring City", top_city, icon="📍")
        ...
        with col_left:
            ...
            if not skills_df.empty:
                fig = horizontal_bar(skills_df, x="job_count", y="skill_name", title="")
        ...
        with col_left2:
            ...
            if not sal_df.empty:
                fig = histogram(sal_df, x="avg_salary_usd", title="", nbins=40)
                st.plotly_chart(fig, use_container_width=True)
            else:
